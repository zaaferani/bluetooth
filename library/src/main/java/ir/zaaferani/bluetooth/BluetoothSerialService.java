...
public class BluetoothSerialService {
    ...
    public HassanView mHassanView;
    /**
     * Constructor. Prepares a new BluetoothChat session.
     * @param context  The UI Activity Context
     * @param handler  A Handler to send messages back to the UI Activity
     */
    public BluetoothSerialService(Context context, Handler handler, TextView v) {
        mAdapter = BluetoothAdapter.getDefaultAdapter();
        mState = STATE_NONE;
        mHandler = handler;
        mContext = context;
        mAllowInsecureConnections = true;
        mHassanView = new HassanView(v);
    }

//    public BluetoothSerialService(Context context, Handler handler, HassanView hv) {
//        mAdapter = BluetoothAdapter.getDefaultAdapter();
//        mState = STATE_NONE;
//        mHandler = handler;
//        mContext = context;
...
//    }
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Global.TOAST, mContext.getString(R.string.toast_unable_to_connect) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(Global.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Global.TOAST, mContext.getString(R.string.toast_connection_lost) );
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHassanView.write(buffer, bytes);
//                    mEmulatorView.write(buffer, bytes);  // TODO write read data
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(Global.MESSAGE_WRITE, buffer.length, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
